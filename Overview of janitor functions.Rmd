...
[related reference](https://garthtarr.github.io/meatR/janitor.html#crosstabulation)
[Cleaning and Exploring Data with the “janitor” Package](https://towardsdatascience.com/cleaning-and-exploring-data-with-the-janitor-package-ee4a3edf085e)
...
iris %>% 
  tabyl(Species, Sepal.Length) %>% 
  adorn_totals(where = c("row","col")) |> View()
```
...
q <- data.frame(v1 = c(1, NA, 3),
                ...
                v3 = c("a", NA, "b"))
q %>%
  remove_empty()# gives same results as above
```
